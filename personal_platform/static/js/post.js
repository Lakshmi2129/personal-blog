...
const blog_posts = () => {
    $.get('add_post_blogs', function(res) {
        ...
        for (i = 0; i < resData.length; i++) {
            ...
            <img src=" ${resData[i].image}" class="card-img-top" height="220">
            ...
            <i onclick="blog_delete(this)" delid=" ${resData[i].pk}" class="mdi mdi-delete text-danger text-danger" style="cursor:pointer;font-size:40px;"></i>
            </div>
            <div class="card-body">
            <h3 class="card-title">
            <div class="post_content">
            <h3><a href="">${resData[i].title}</a>
            </h3>
            </div>
            </h3>
